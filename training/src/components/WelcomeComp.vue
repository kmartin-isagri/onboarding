<template>
    <div>
        ...
        <div class="d-flex align-center justify-center text">{{ text }}</div>
    </div>
</template>
<script lang="ts">
...
@Component({})
export class WelcomeComp extends Vue {
  @Prop({ default: "Welcome to Bobbee !"}) text!: string;
}

export default toNative(WelcomeComp);
</script>
<style scoped>
* {
